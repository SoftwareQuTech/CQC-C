...
latex_documents = [(master_doc, "CQC_C.tex", "CQC_C Documentation", "Author", "manual")]
...
man_pages = [(master_doc, "CQC_C", "CQC_C Documentation", [author], 1)]
